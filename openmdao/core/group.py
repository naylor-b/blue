...
class Group(System):
    ...
    def _get_auto_ivc_out_info(self, tgts, remote_ins, all_abs2meta, abs2meta, group_meta):
        ...
        for tgt in tgts:
            ...
            if tgt in remote_ins:  # remote somewhere
                ...
                self._resolve_connected_input_defaults(tgts, remote_ins, all_abs2meta, abs2meta,
                                                       group_meta)
        ...
        with multi_proc_exception_check(self.comm):
            ...
            for src, tgts in sorted(auto2tgt.items()):
                ...
                if tgts[0] in disc_ins:
                    ...
                    tgt, sz, val, remote = self._get_auto_ivc_out_info(tgts, remote_ins,
                                                                       all_abs2meta,
                                                                       abs2meta, gmeta)
                    if 'units' in gmeta:
                        units = gmeta['units']
    ...
    def _resolve_connected_input_defaults(self, tgts, remote_ins, all_abs2meta, abs2meta,
                                          group_meta):
